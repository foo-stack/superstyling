import { Avatar, HStack } from "@superstyling/core";
...
```tsx
import { Avatar } from "@superstyling/core";
```
...
<PropsTable
  props={[
    ...
    { name: "circular", type: "boolean", default: "false", description: "Round corners fully. Leave off for a square avatar." },
  ]}
/>
