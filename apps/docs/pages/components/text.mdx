...
```tsx
import { Text } from "@superstyling/core";
```
...
<PropsTable
  props={[
    { name: "fontSize", type: "$1 | $2 | $3 | … | number", default: "$3", description: "Token or raw pixel size. Tokens preserve responsive scaling." },
    { name: "fontWeight", type: `"100"–"900"`, default: `"400"`, description: "Weight string. Use numeric values to match the design system." },
    { name: "color", type: "ColorToken | CSS color", default: "$foreground", description: "Text color. Prefer semantic tokens so dark mode works automatically." },
    { name: "numberOfLines", type: "number", description: "Caps line count. Adds ellipsis on overflow. Use with maxWidth/flex to control where the cut happens." },
  ]}
/>
